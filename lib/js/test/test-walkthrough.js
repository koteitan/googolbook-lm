        ...
        try {
            ...
            if (!sendBtn.disabled) {
                ...
                const checkSendComplete = () => {
                    ...
                    // RAG結果が表示されたかチェック（ローディングメッセージ以外）
                ...
                if (finalResponseContent.length > 0) {
                    ...
                    console.log(finalResponseContent.substring(0, 2000)); // 最初の2000文字
                    if (finalResponseContent.length > 2000) {
                        console.log(`... (残り${finalResponseContent.length - 2000}文字省略)`);
                    }
                    console.log('--- Response End ---');
                } else {
                    console.log('Response内容: (空)');
                }
                
                // RAG窓の詳細内容表示
                console.log('\n=== RAG窓詳細内容 ===');
                if (finalRagContent.length > 0) {
                    console.log('RAG Search Results内容:');
                    console.log('--- RAG Results Begin ---');
                    console.log(finalRagContent.substring(0, 2000)); // 最初の2000文字
                    if (finalRagContent.length > 2000) {
                        console.log(`... (残り${finalRagContent.length - 2000}文字省略)`);
                    }
                    console.log('--- RAG Results End ---');
                } else {
                    console.log('RAG Search Results内容: (空)');
                }
