 ...
 * 
 * This tool uses the same tokenization logic as lib/js/rag-common.js to test
...
async function main() {
    ...
    if (tokenizeMode === 'mecab' || tokenizeMode === 'tinysegmenter') {
        ...
        console.log('This matches the browser-side tokenization in lib/js/rag-common.js.');
    } else {
        console.log('\n=== Configuration ===');
