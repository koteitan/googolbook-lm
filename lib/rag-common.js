...
const MODEL_LIMITS = {
    ...
    'openrouter/openai/o3-pro': 200000 * 3.5,               // ~200k tokens → ~700k chars (estimated)
...
const PROVIDER_CONFIG = {
    ...
    'azure-openai': {
        ...
        apiKeyPlaceholder: 'Azure OpenAI API キーを入力',
        apiKeyHelp: '<a href="https://portal.azure.com/" target="_blank">Azure OpenAI API key</a>を入力してください',
