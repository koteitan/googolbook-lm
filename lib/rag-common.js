...
async function generateAIResponse(elements, query, bodyResults, titleResults, apiKey) {
    try {
        ...
        // Create context from body results with citation numbers
        ...
        // Create context from title results with citation numbers
...
IMPORTANT: When referencing information from the context, always cite the source using the provided reference numbers in square brackets (e.g., [1], [2], [3]). Each source document in the context is numbered with [1], [2], etc. Use these citation numbers throughout your response to indicate which source you are referencing for each piece of information.
